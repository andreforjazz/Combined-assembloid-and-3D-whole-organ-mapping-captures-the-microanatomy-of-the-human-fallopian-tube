function [numann,ctlist0]=annotation_bounding_boxes(filename,outpth,nm,numclass,fn,imlabel)
disp('3. of 3. Creating bounding box tiles of all annotations')
...
for pk=1:max(L(:))
    ...
    tmpim=imread([filename,'.tif'],'PixelRegion',{[rect(3) rect(4)],[rect(1) rect(2)]});
