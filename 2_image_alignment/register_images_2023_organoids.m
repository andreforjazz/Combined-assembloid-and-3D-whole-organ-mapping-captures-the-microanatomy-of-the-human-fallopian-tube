function register_images_2023_organoids(pth,IHC,E,zc,szz,sk,tpout,regE)
...
[imzc,TAzc]=get_ims_organoids(pth,nm,tp,IHC);
...
for kk=1:length(mv)
    ...
    [immv0,TAmv]=get_ims_organoids(pth,nm,tp,IHC);
...
%         if IHC==1;ct=0.8;else;ct=0.92;end
        if IHC==1;ct=0.8;else;ct=0.98;end
